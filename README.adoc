...
On the **Basics** pane. Under the `Resource group`, click on the `Create new` link and type in `guideGroup` as the name of the resource group. Please note, the plan also supports to use an existing resource group while the group is required to be empty. 
...
The result should be same as following

[role="no_copy"]
----
NAME       RESOURCE GROUP    LOCATION    SKU    LOGIN SERVER          CREATION DATE         ADMIN ENABLED
---------  ----------------  ----------  -----  --------------------  --------------------  ---------------
acr1234d5  guideGroup        eastus      Basic  acr1234d5.azurecr.io  2024-08-09T17:53:38Z  True
----
...
The cluster name, formatted as `cluster1234d5`, should be identified in the following output.

[role="no_copy"]
----
Name           Location    ResourceGroup    KubernetesVersion    CurrentKubernetesVersion    ProvisioningState    Fqdn
-------------  ----------  ---------------  -------------------  --------------------------  -------------------  -----------------------------------------------
cluster1234d5  eastus      guideGroup       1.29                 1.29.7                      Succeeded            cluster1234d5-dns-pazznf8n.hcp.eastus.azmk8s.io
----
